...
if(!function_exists('homey_instant_exp_booking')) {
    function homey_instant_exp_booking() {
        ...
        if ($current_user->ID == 0 && $no_login_needed_for_exp_booking == "yes" && isset($_REQUEST['new_reser_request_user_email'])) {
            $user = get_user_by('email', $email);
...
if( !function_exists('homey_exp_instance_step_1') ) {
    function homey_exp_instance_step_1() {
        ...
        if($current_user->ID == 0 && $no_login_needed_for_exp_booking == "yes" && isset($_REQUEST['email'])) {
            $user = get_user_by('email', $email);
