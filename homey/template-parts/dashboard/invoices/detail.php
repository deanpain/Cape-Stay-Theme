            ...
            <ul class="list-unstyled">
                ...
                <?php if($is_reservation_invoice) { ?>
                    ...
                    <?php if($is_hourly == 'yes') {
                        $checkin_hour = get_post_meta($resv_id, 'reservation_checkin_hour', true);
                        $check_out_hour = get_post_meta($resv_id, 'reservation_checkout_hour', true);
                        ?>
                        <li><strong><?php esc_html_e('Check In:', 'homey'); ?></strong> <?php echo esc_attr($checkin_hour); ?></li>
                        <li><strong><?php esc_html_e('Check Out:', 'homey'); ?></strong> <?php echo esc_attr($check_out_hour); ?></li>
                    <?php }else{
