...
<div class="item-wrap <?php echo is_null($template_args) ? '' : __( $template_args['listing-item-view'] ); ?> infobox_trigger homey-matchHeight" data-dir="listing-item" data-id="<?php echo $post->ID; ?>">
