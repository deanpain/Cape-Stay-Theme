...
if($instant_booking) {
	...
	$btn_name = esc_html__('Enquire', 'homey');
}
...
<div id="overlay-booking-module" class="overlay-booking-module overlay-contentscale">
	<div class="overlay-search-title"><?php echo esc_html__('Enquire', 'homey'); ?></div>
		...
		<div class="block">
			<div class="sidebar-booking-module-body">
				<div class="homey_notification search-wrap search-banner">
					...
					<?php } else { ?>
						<button id="request_for_reservation_mobile" type="button" class="btn btn-full-width btn-primary"><?php echo esc_html__('Enquire', 'homey'); ?></button>
...
<div class="overlay-booking-btn visible-sm visible-xs">
    ...
    <?php
        ...
        <button type="button" data-toggle="modal" data-target="#modal-contact-host" class="trigger-overlay btn btn-primary" id="form-modal"><?php echo esc_html__('Enquire', 'homey'); ?></button>
    <?php
    }
	?>
</div>
