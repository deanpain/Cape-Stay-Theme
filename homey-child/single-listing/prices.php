...
<div id="price-section">
                    ...
                    <div class="block-body">
                        <h3 class="title"><?php echo esc_attr(homey_option('sn_prices_heading')); ?></h3>
                            <ul class="detail-list">
                                ...
                                <span>From
                                    <?php
                                    echo homey_formatted_price($night_price, true, true); ?><?php echo esc_attr($price_separator); ?> <?php echo homey_get_price_label();?>
                                </span>
                                <?php } else {
    ...
    <?php
        ...
        if (!empty($nightsbridgeBBID)) {
            get_template_part('/single-listing/NB_modalCaller');
            }
    ?>
</div>
