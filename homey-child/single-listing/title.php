...
<div class="title-section title-v1">
    <div class="<?php echo esc_attr($title_class); ?>">
        <div class="block-body">
           ...
           <address><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo esc_attr($address); ?>
           in the suburb of <a href="/<?php echo $lowercaseVariable; ?>" target="_blank" title="Show all listings in this Suburb"><?php echo $mycity; ?>
       </address>
           <?php } ?>
