...
if( !function_exists('homey_get_image_placeholder')){
    function homey_get_image_placeholder( $featured_image_size ){
        ...
        if( intval( $feat_img_width ) > 0 && intval( $feat_img_height ) > 0 ) {
            return '<img src="/wp-content/uploads/defaultimage_prop2.gif' . '&text=' . urlencode( $title_img_text ) . '" alt="'.esc_attr__('placeholder', 'homey').'" />';
        }
...
if( !function_exists('homey_get_image_placeholder_url')){
    function homey_get_image_placeholder_url( $image_size ){
        ...
        if( intval( $img_width ) > 0 && intval( $img_height ) > 0 ) {
            return '<img src="https://www.capestay.co.za/wp-content/uploads/defaultimage_prop2.gif" />' . esc_attr($img_width) . 'x' . esc_attr($img_height) . '&text=' . urlencode( $img_text ) . '';
        }
...
if( !function_exists('homey_countries_list') ) {
    function homey_countries_list() {
        $Countries = array(
            ...
            'BL' => esc_html__('Saint Barthélemy', 'homey'),
...
if(!function_exists('homey_custom_pagination')) {
    function homey_custom_pagination($perpage, $totalres) {
        ...
        <li class="page-item">
          <a class="page-link" href="&page-num=<?php echo $startpage ?>" tabindex="-1" aria-label="Previous">
        ...
        if($curpage >= 2){ ?>
        <li class="page-item"><a class="page-link" href="&page-num=<?php echo $previouspage ?>"><?php echo $previouspage ?></a></li>
        <?php } ?>

        <li class="page-item active"><a class="page-link" href="&page-num=<?php echo $curpage ?>"><?php echo $curpage ?></a></li>
        
        <?php if($curpage != $endpage){ ?>
            <li class="page-item"><a class="page-link" href="&page-num=<?php echo $nextpage ?>"><?php echo $nextpage ?></a></li>
        <?php }

        if($curpage != $endpage){ ?>
        <li class="page-item">
          <a class="page-link" href="&page-num=<?php echo $endpage ?>" aria-label="Next">
        ...
        /*$output = '<nav class="pagination-wrap" aria-label="Page navigation">';
            $output .= '<ul class="pagination">';
                ...
                $output .= '<li><a href="#">2</a></li>';
                $output .= '<li><a href="#">3</a></li>';
                $output .= '<li><a href="#">4</a></li>';
                $output .= '<li><a href="#">5</a></li>';
                $output .= '<li>
