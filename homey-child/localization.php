...
if( !function_exists('homey_get_localization')) {
	function homey_get_localization() {
		...
		$localization = array(
			...
			'drag_drop_img' => wp_kses(__( 'Drag and drop the images to customise the gallery order.<br>Click on the star icon to set the featured image', 'homey' ), $allowed_html_array),
			'image_size_text' => esc_html__('(Minimum size 800 x 600 px; Maximum size 1920 x 900 px) <br/>IF YOU ARE GETTING AN ERROR PLEASE CHECK YOUR DIMENSIONS!', 'homey'),
			...
			'rentals_label' => esc_html__( 'Listings', 'homey' ),
			'rental_label' => esc_html__( 'Listings', 'homey' ),
			...
			'native_lang_label' => esc_attr__('Telephone Number', 'homey'),
			'other_lang_label' => esc_html__('Cellphone Number', 'homey'),
