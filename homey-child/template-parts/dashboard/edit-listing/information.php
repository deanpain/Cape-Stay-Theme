...
<div id="information-tab" class="tab-pane fade <?php echo esc_attr($class); ?>">
    ...
    <div class="block-body">
       ...
       <?php if($hide_fields['room_type'] != 1) { ?>
        ...
        <div class="col-sm-12">
            <label> Here you can build a Price Table for the various price periods by selecting the Table Icon next to the "?" icon.</label>
            </div>
                    ...
                    foreach ( $fields_array as $value ) {
                        ...
                        if($field_type == 'textarea') {
                            ...
                            if($hide_fields[$field_name] != 1) {
                                ...
                                // default settings - Kv_front_editor.php
                                $content1 = $listing_meta_data['homey_'.$field_name][0];
