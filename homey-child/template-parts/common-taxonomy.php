...
if (function_exists('z_taxonomy_image_url'))
    $tax_image = z_taxonomy_image_url();

if ( !empty($tax_image) ) {
    $imgFallback = $tax_image;
} else {
    $imgFallback = "https://mlbyiwdkornc.i.optimole.com/cb:bEez.41606/w:1903/h:180/q:mauto/f:best/https://www.capestay.co.za/wp-content/uploads/main-site-assets/random/all-header.jpg";
}
...
<section class="main-content-area listing-page <?php echo $full_width_page;?>">
    <div class="container 90percent term-image">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 term-image" style="background-image: url('<?php echo $imgFallback ; ?>');">
    ...
    <div class="container 90percent">
        <div class="row">
            
            <a href="https://www.capestay.co.za/search-results?city=<?php echo $current_term->slug; ?>" target="_blank" class="mapSwitch">Switch to Searching with the Map &nbsp; <i class="fa fa-globe" aria-hidden="true"></i></a>
