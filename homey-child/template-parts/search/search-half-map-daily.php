            ...
            <form class="clearfix">
                ...
                <div class="half-map-search-buttons">
                 ...
                 <div class="switch" id="switch">
                    ...
                    <label for="toggle"><i><div class="fa"></div></i></label>
                    <span></span>
                </div>

                <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
                    <script>
                        // Retrieve the elements using their IDs or other selectors
                        const element1 = document.getElementById('leftList');
                        const element2 = document.getElementById('metaMap');
                        
                        // Delay the execution of the code by 3 seconds
                        setTimeout(function() {
                          // Add the CSS class to the elements
                          element1.classList.add('mapOff');
                          element2.classList.add('mapOff');
                        }, 8000);


                    $(document).ready(function(){
                      $(".switch").click(function(){
                        $("#leftList").toggleClass("mapOff");
                        $("#metaMap").toggleClass("mapOff");
                      });
                    });
                    </script>
